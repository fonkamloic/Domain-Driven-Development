...
class TodoList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocListener<NoteFormBloc, NoteFormState>(
      listenWhen: (p, c) => c.note.todos.isFull != p.note.todos.isFull,
      ...
      child: Consumer<FormTodos>(
        builder: (context, formTodos, child) {
          return ImplicitlyAnimatedReorderableList<TodoItemPrimitive>(
            ...
            itemBuilder: (context, itemAnination, item, index) {
              return Reorderable(
              ...
              title: TextFormField(
                ...
                validator: (_) {
                  return context.bloc<NoteFormBloc>().state.note.todos.value.fold(
                      // failure stemming form the TodoList length should Not be displayed
                      (l) => null,
                      (todoList) => todoList[index].name.value.fold(
                            (f) => f.maybeMap(
                              ...
                              multiline: (_) => "Cannot be multiple lines",
                            ),
                            (r) => null,
                          ));
                },
