...
// ignore: unused_element
  _TodosChanged todosChanged(KtList<TodoItemPrimitive> todoList) {
...
mixin _$NoteFormEvent {
  ...
  Result when<Result extends Object>({
    ...
    @required Result todosChanged(KtList<TodoItemPrimitive> todoList),
  ...
  Result maybeWhen<Result extends Object>({
    ...
    Result todosChanged(KtList<TodoItemPrimitive> todoList),
    Result saved(),
...
class __$TodosChangedCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_TodosChanged(
      todoList == freezed
          ? _value.todoList
          : todoList as KtList<TodoItemPrimitive>,
    ));
  }
}
...
abstract class _TodosChanged implements NoteFormEvent {
  const factory _TodosChanged(KtList<TodoItemPrimitive> todoList) =
      _$_TodosChanged;

  KtList<TodoItemPrimitive> get todoList;
  _$TodosChangedCopyWith<_TodosChanged> get copyWith;
}
