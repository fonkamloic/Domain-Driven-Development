...
class _$_Deleted with DiagnosticableTreeMixin implements _Deleted {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'NoteActorEvent.deleted'))
...
class _$_Initial with DiagnosticableTreeMixin implements _Initial {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties..add(DiagnosticsProperty('type', 'NoteActorState.initial'));
  }
...
class _$_DeleteFailure with DiagnosticableTreeMixin implements _DeleteFailure {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'NoteActorState.deleteFailure'))
...
class _$_DeleteSuccess with DiagnosticableTreeMixin implements _DeleteSuccess {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'NoteActorState.deleteSuccess'));
  }
...
class _$_ActionInProgress
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'NoteActorState.actionInProgress'));
  }
